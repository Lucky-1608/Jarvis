"""
Jarvis OS — Nvidia NIM AI Provider (Fallback/High-Performance).

Uses the OpenAI-compatible chat completions API exposed by Nvidia NIM.
"""
    ...
    async def chat(
        ...
        *,
        ...
        raise ConnectionError(
            f"Nvidia chat failed after {self._max_retries} attempts: {last_error}"
        )
